...
if {[string length [info commands new_project]]} {
   new_project -name lab8_mem_stage_struc -folder "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_struc"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_struc"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_struc/hds/add_files.tcl"}
