...
if {[string length [info commands new_project]]} {
   new_project -name lab8_arbiter -folder "C:/HDS/CAD/CAD_lib/ps/lab8_arbiter"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab8_arbiter"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab8_arbiter/hds/add_files.tcl"}
