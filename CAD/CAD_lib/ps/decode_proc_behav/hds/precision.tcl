...
if {[string length [info commands new_project]]} {
   new_project -name decode_proc_behav -folder "C:/HDS/CAD/CAD_lib/ps/decode_proc_behav"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/decode_proc_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/decode_proc_behav/hds/add_files.tcl"}
