...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/Increment_mixed/Increment_mixed.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/Increment_mixed"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/Increment_mixed/hds/add_files.tcl"}
