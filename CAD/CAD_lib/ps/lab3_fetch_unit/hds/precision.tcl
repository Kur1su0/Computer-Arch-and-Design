...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab3_fetch_unit/lab3_fetch_unit.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab3_fetch_unit"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab3_fetch_unit/hds/add_files.tcl"}
