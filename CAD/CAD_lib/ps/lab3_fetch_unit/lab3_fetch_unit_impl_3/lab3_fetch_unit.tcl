if { ![project_exists {lab3_fetch_unit}] } {
     project_new {lab3_fetch_unit}
} else {
     project_open {lab3_fetch_unit}
}
set_project_settings -cmp {lab3_fetch_unit}
if { ![project_settings_exist -sim lab3_fetch_unit] } {
        set_project_settings -sim lab3_fetch_unit
}
set_global_assignment -section_id {lab3_fetch_unit} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {EDIF_FILE} {lab3_fetch_unit.edf}
...
if { [file exists {lab3_fetch_unit_altera.prop}] } {
  source lab3_fetch_unit_altera.prop
}
set_global_assignment -name {FAMILY} {MAXV}
set_global_assignment -section_id {lab3_fetch_unit} -name {DEVICE} {5M2210ZF324A5}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {lab3_fetch_unit_pnr_constraints.sdc}
