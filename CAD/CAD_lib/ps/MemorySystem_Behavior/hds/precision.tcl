...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/MemorySystem_Behavior/MemorySystem_Behavior.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/MemorySystem_Behavior"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/MemorySystem_Behavior/hds/add_files.tcl"}
