...
if {[string length [info commands new_project]]} {
   new_project -name mem_system -folder "C:/HDS/CAD/CAD_lib/ps/mem_system"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/mem_system"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/mem_system/hds/add_files.tcl"}
