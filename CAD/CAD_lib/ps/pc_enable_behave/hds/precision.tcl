...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/pc_enable_behave/pc_enable_behave.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/pc_enable_behave"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/pc_enable_behave/hds/add_files.tcl"}
