...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/mem_behave/mem_behave.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/mem_behave"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/mem_behave/hds/add_files.tcl"}
