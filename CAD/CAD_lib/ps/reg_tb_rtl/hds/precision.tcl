...
if {[string length [info commands new_project]]} {
   new_project -name reg_tb_rtl -folder "C:/HDS/CAD/CAD_lib/ps/reg_tb_rtl"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/reg_tb_rtl"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/reg_tb_rtl/hds/add_files.tcl"}
