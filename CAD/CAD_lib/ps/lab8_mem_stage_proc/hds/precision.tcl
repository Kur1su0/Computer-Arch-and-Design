...
if {[string length [info commands new_project]]} {
   new_project -name lab8_mem_stage_proc -folder "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_proc"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_proc"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_proc/hds/add_files.tcl"}
