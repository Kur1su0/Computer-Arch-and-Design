...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab10_whole_syst/lab10_whole_syst.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab10_whole_syst"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab10_whole_syst/hds/add_files.tcl"}
