...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/nop_ctrl/nop_ctrl.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/nop_ctrl"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/nop_ctrl/hds/add_files.tcl"}
