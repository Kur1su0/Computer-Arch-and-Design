...
if {[string length [info commands new_project]]} {
   new_project -name func_reg -folder "C:/HDS/CAD/CAD_lib/ps/func_reg"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/func_reg"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/func_reg/hds/add_files.tcl"}
