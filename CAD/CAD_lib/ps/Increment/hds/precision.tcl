...
if {[string length [info commands new_project]]} {
   new_project -name Increment -folder "C:/HDS/CAD/CAD_lib/ps/Increment"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/Increment"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/Increment/hds/add_files.tcl"}
