...
if {[string length [info commands new_project]]} {
   new_project -name rst_syn -folder "C:/HDS/CAD/CAD_lib/ps/rst_syn"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/rst_syn"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/rst_syn/hds/add_files.tcl"}
