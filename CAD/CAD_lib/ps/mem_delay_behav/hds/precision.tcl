...
if {[string length [info commands new_project]]} {
   new_project -name mem_delay_behav -folder "C:/HDS/CAD/CAD_lib/ps/mem_delay_behav"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/mem_delay_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/mem_delay_behav/hds/add_files.tcl"}
