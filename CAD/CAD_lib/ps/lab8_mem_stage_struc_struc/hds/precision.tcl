...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_struc_struc/lab8_mem_stage_struc_struc.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_struc_struc"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_struc_struc/hds/add_files.tcl"}
