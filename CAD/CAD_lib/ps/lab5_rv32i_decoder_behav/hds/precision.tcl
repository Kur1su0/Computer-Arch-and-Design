...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab5_rv32i_decoder_behav/lab5_rv32i_decoder_behav.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab5_rv32i_decoder_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab5_rv32i_decoder_behav/hds/add_files.tcl"}
