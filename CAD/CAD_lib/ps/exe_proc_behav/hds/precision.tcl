...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/exe_proc_behav/exe_proc_behav.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/exe_proc_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/exe_proc_behav/hds/add_files.tcl"}
