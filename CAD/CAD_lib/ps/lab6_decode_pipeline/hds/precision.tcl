...
if {[string length [info commands new_project]]} {
   new_project -name lab6_decode_pipeline -folder "C:/HDS/CAD/CAD_lib/ps/lab6_decode_pipeline"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab6_decode_pipeline"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab6_decode_pipeline/hds/add_files.tcl"}
