...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/read_ctrl/read_ctrl.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/read_ctrl"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/read_ctrl/hds/add_files.tcl"}
