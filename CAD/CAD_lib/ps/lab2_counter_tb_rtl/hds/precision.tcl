...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab2_counter_tb_rtl/lab2_counter_tb_rtl.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab2_counter_tb_rtl"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab2_counter_tb_rtl/hds/add_files.tcl"}
