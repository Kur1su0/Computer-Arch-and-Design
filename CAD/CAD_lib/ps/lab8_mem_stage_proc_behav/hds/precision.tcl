...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_proc_behav/lab8_mem_stage_proc_behav.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_proc_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab8_mem_stage_proc_behav/hds/add_files.tcl"}
