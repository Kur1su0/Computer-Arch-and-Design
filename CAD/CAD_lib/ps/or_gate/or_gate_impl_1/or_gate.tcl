if { ![project_exists {or_gate}] } {
     ...
     project_open {or_gate}
}
set_project_settings -cmp {or_gate}
if { ![project_settings_exist -sim or_gate] } {
        set_project_settings -sim or_gate
}
set_global_assignment -section_id {or_gate} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {EDIF_FILE} {or_gate.edf}
...
if { [file exists {or_gate_altera.prop}] } {
  source or_gate_altera.prop
}
set_global_assignment -name {FAMILY} {MAXV}
set_global_assignment -section_id {or_gate} -name {DEVICE} {5M2210ZF324A5}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {or_gate_pnr_constraints.sdc}
