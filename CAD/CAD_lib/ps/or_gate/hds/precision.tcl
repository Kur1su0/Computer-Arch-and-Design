...
if {[string length [info commands new_project]]} {
   new_project -name or_gate -folder "C:/HDS/CAD/CAD_lib/ps/or_gate"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/or_gate"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/or_gate/hds/add_files.tcl"}
