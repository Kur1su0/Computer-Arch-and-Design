...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab2_counter/lab2_counter.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab2_counter"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab2_counter/hds/add_files.tcl"}
