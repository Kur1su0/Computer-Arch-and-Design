...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab8_writeback_mixed/lab8_writeback_mixed.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab8_writeback_mixed"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab8_writeback_mixed/hds/add_files.tcl"}
