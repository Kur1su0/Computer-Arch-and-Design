...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab9_reg_tracker/lab9_reg_tracker.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab9_reg_tracker"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab9_reg_tracker/hds/add_files.tcl"}
