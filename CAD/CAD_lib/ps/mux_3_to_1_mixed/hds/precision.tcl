...
if {[string length [info commands new_project]]} {
   new_project -name mux_3_to_1_mixed -folder "C:/HDS/CAD/CAD_lib/ps/mux_3_to_1_mixed"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/mux_3_to_1_mixed"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/mux_3_to_1_mixed/hds/add_files.tcl"}
