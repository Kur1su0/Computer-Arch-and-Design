...
if {[string length [info commands new_project]]} {
   new_project -name or_gate_behave -folder "C:/HDS/CAD/CAD_lib/ps/or_gate_behave"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/or_gate_behave"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/or_gate_behave/hds/add_files.tcl"}
