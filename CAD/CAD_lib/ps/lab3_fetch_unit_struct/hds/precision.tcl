...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab3_fetch_unit_struct/lab3_fetch_unit_struct.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab3_fetch_unit_struct"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab3_fetch_unit_struct/hds/add_files.tcl"}
