...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab6_decode_pipeline_struc/lab6_decode_pipeline_struc.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab6_decode_pipeline_struc"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab6_decode_pipeline_struc/hds/add_files.tcl"}
