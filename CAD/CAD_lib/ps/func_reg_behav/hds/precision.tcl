...
if {[string length [info commands new_project]]} {
   new_project -name func_reg_behav -folder "C:/HDS/CAD/CAD_lib/ps/func_reg_behav"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/func_reg_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/func_reg_behav/hds/add_files.tcl"}
