...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab10_combine_struc/lab10_combine_struc.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab10_combine_struc"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab10_combine_struc/hds/add_files.tcl"}
