...
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/MemorySystem_Behavior.vhd"} -format {VHDL_2008} -work CAD_lib
...
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/exe_struc.vhd"} -format {VHDL_2008} -work CAD_lib
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/lab3_fetch_behave.vhd"} -format {VHDL_2008} -work CAD_lib
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/lab8_mem_stage_proc_behav.vhd"} -format {VHDL_2008} -work CAD_lib
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/lab8_mem_stage_struc.vhd"} -format {VHDL_2008} -work CAD_lib
...
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/lab10_whole_syst_struct.vhd"} -format {VHDL_2008} -work CAD_lib
add_input_file {"C:/HDS/CAD/CAD_lib/hdl/lab10_combine_struc.vhd"} -format {VHDL_2008} -work CAD_lib
setup_design -design lab10_combine
