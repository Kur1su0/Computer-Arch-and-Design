if { ![project_exists {mux_2_to_1}] } {
     project_new {mux_2_to_1}
} else {
     project_open {mux_2_to_1}
}
set_project_settings -cmp {mux_2_to_1}
if { ![project_settings_exist -sim mux_2_to_1] } {
        set_project_settings -sim mux_2_to_1
}
set_global_assignment -section_id {mux_2_to_1} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {EDIF_FILE} {mux_2_to_1.edf}
...
if { [file exists {mux_2_to_1_altera.prop}] } {
  source mux_2_to_1_altera.prop
}
set_global_assignment -name {FAMILY} {MAXV}
set_global_assignment -section_id {mux_2_to_1} -name {DEVICE} {5M2210ZF324A5}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {mux_2_to_1_pnr_constraints.sdc}
