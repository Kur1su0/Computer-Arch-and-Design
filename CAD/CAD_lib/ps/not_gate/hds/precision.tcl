...
if {[string length [info commands new_project]]} {
   new_project -name not_gate -folder "C:/HDS/CAD/CAD_lib/ps/not_gate"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/not_gate"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/not_gate/hds/add_files.tcl"}
