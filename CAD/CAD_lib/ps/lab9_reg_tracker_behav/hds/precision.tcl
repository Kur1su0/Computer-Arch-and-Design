...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab9_reg_tracker_behav/lab9_reg_tracker_behav.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab9_reg_tracker_behav"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab9_reg_tracker_behav/hds/add_files.tcl"}
