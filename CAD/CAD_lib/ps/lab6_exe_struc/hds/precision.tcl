...
if {[string length [info commands new_project]]} {
   open_project "C:/HDS/CAD/CAD_lib/ps/lab6_exe_struc/lab6_exe_struc.psp"
   new_impl
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/lab6_exe_struc"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/lab6_exe_struc/hds/add_files.tcl"}
