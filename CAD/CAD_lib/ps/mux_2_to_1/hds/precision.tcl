...
if {[string length [info commands new_project]]} {
   new_project -name mux_2_to_1 -folder "C:/HDS/CAD/CAD_lib/ps/mux_2_to_1"
} else {
   set_working_dir "C:/HDS/CAD/CAD_lib/ps/mux_2_to_1"
}
...
catch {source "C:/HDS/CAD/CAD_lib/ps/mux_2_to_1/hds/add_files.tcl"}
